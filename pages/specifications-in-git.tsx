            ...
            <main>
                <Layout title="Specifications in Git" shortTitle="Specifications in Git" href="/specifications-in-git" children={(
                    ...
                    <Text mt={12} maxWidth="1920px">
                        ...
                        <Heading as="h2" size="md" mb={4}>Standardizing version control</Heading>
                        ...
                        <Heading as="h2" size="md" mt={12} mb={4}>Difficulty using Git</Heading>
                        ...
                        <Heading as="h2" size="md" mt={12} mb={4}>Making Git the easy way to store specifications</Heading>
                        ...
                        <Heading as="h2" size="md" mt={12} mb={4}>Self-hosting GitFeatures</Heading>
                        ...
                        <Heading as="h2" size="md" mt={12} mb={4}>Trees and documents that are manageable like Mind Maps</Heading>
                        ...
                        <Heading as="h2" size="md" mt={12} mb={4}>Tagging your specification with your code and feature releases</Heading>
